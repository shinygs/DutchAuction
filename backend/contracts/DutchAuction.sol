...
contract DutchAuction {
  ...
  // Constructor
  constructor(uint _itemsToAuction, uint _reservePrice, 
  ...
  function getCurrentItemPrice() public view atStage(Stages.StageAcceptingBids) returns (uint)
  {
  ...
  function bid(uint quantity) public payable atStage(Stages.StageAcceptingBids) {
    ...
    emit BidReceived(msg.sender, quantity);
  }
